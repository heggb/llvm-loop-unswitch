; ModuleID = '/home/talalaec/llvm-project/llvm-loop-unswitch/build/ir/loop1_input.ll'
source_filename = "/home/talalaec/llvm-project/llvm-loop-unswitch/tests_src/loop1_input.c"
...
if.then.ipp:                                      ; preds = %for.cond.ipp
  ...
  %mul.ipp = mul nsw i32 %1, 2
  %idxprom1.ipp = sext i32 %i.0.ipp to i64
  %arrayidx2.ipp = getelementptr inbounds i32, ptr %a, i64 %idxprom1.ipp
  store i32 %mul.ipp, ptr %arrayidx2.ipp, align 4
