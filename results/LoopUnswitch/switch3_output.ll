; ModuleID = '/home/talalaec/llvm-project/llvm-loop-unswitch/build/ir/switch3_input.ll'
source_filename = "/home/talalaec/llvm-project/llvm-loop-unswitch/tests_src/switch3_input.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: noinline nounwind uwtable
define dso_local void @doSomethingGlobal() #0 {
entry:
  ret void
}
...
ipp.sw.guard.cont:                                ; preds = %entry
  ...
  br i1 %1, label %ipp.sw.ph.case1, label %for.cond
...
for.cond.sw3:                                     ; preds = %ipp.sw.ph.case1, %sw.bb1.sw7
  %i.0.sw4 = phi i32 [ 0, %ipp.sw.ph.case1 ], [ %inc.sw18, %sw.bb1.sw7 ]
...
sw.bb1.sw7:                                       ; preds = %for.cond.sw3
  ...
  %3 = load i32, ptr %arrayidx3.sw9, align 4
  %mul.sw10 = mul nsw i32 %3, 2
  store i32 %mul.sw10, ptr %arrayidx3.sw9, align 4
  %inc.sw18 = add nsw i32 %i.0.sw4, 1
  br label %for.cond.sw3, !llvm.loop !6

for.cond:                                         ; preds = %ipp.sw.guard.cont, %sw.default
  %i.0 = phi i32 [ %inc, %sw.default ], [ 0, %ipp.sw.guard.cont ]
  %cmp = icmp slt i32 %i.0, %n
  br i1 %cmp, label %sw.default, label %for.end

sw.default:                                       ; preds = %for.cond
  call void @doSomethingGlobal()
  %inc = add nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !6

for.end:                                          ; preds = %for.cond, %for.cond.sw3, %for.cond.sw
  ret void
}
