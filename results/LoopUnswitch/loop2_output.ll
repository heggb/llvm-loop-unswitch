; ModuleID = '/home/talalaec/llvm-project/llvm-loop-unswitch/build/ir/loop2_input.ll'
source_filename = "/home/talalaec/llvm-project/llvm-loop-unswitch/tests_src/loop2_input.c"
...
for.cond.ipp:                                     ; preds = %ipp.unsw.ph.true, %if.end.ipp
  %i.0.ipp = phi i32 [ 0, %ipp.unsw.ph.true ], [ %inc.ipp, %if.end.ipp ]
...
if.then.ipp:                                      ; preds = %for.cond.ipp
  ...
  %1 = load i32, ptr %arrayidx.ipp, align 4
  %cmp1.ipp = icmp eq i32 %1, 0
  br i1 %cmp1.ipp, label %for.end, label %if.end.ipp

if.end.ipp:                                       ; preds = %if.then.ipp
  %idxprom3.ipp = sext i32 %i.0.ipp to i64
  %arrayidx4.ipp = getelementptr inbounds i32, ptr %A, i64 %idxprom3.ipp
  %2 = load i32, ptr %arrayidx4.ipp, align 4
  %add.ipp = add nsw i32 %2, 1
  store i32 %add.ipp, ptr %arrayidx4.ipp, align 4
...
for.end:                                          ; preds = %for.cond, %for.cond.ipp, %if.then.ipp
  ret void
}
